      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            {/* 네 지표는 적용 범위가 서로 다르다. 디자인 시스템 8.11 이 "숫자만 나열하지 않고
                적용 범위와 기준을 함께 표시"를 요구하므로, note 는 계산식만이 아니라 어떤 문제를
                셌는지까지 밝힌다 — 바로 옆 지표가 "보관 포함"인데 이 지표는 말이 없으면
                같은 범위인지 알 길이 없다. */}
            <Metric
              label="검토 필요 문제"
